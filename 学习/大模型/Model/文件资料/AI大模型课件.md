...
![image-20250312145223729](学习/大模型/Model/文件资料/img/image-20250312145223729.png)
...
![image-20250402170819853](学习/大模型/Model/文件资料/img/image-20250402170819853.png)
...
![image-20250402172313558](学习/大模型/Model/文件资料/img/image-20250402172313558.png)

​	我们定位也很清楚就是大模型应用开发工程师，所以虽然大模型的由来是通过非常的复杂的技术实现的。但是我们并不用都掌握这些原理性的东西，我们就好比站在了巨人的肩上来造房子就可以了。

![image-20250402172450097](学习/大模型/Model/文件资料/img/image-20250402172450097.png)
...
![image-20250414195746710](学习/大模型/Model/文件资料/img/image-20250414195746710.png)
...
![image-20250414171212622](学习/大模型/Model/文件资料/img/image-20250414171212622.png)
...
![image-20250414171348170](学习/大模型/Model/文件资料/img/image-20250414171348170.png)
...
![image-20250414172821847](学习/大模型/Model/文件资料/img/image-20250414172821847.png)
...
![image-20250414194732598](学习/大模型/Model/文件资料/img/image-20250414194732598.png)
...
![image-20250414195444674](学习/大模型/Model/文件资料/img/image-20250414195444674.png)
...
![image-20250414155110189](学习/大模型/Model/文件资料/img/image-20250414155110189.png)
...
![image-20250412221903028](学习/大模型/Model/文件资料/img/image-20250412221903028.png)
...
![image-20250412222607173](学习/大模型/Model/文件资料/img/image-20250412222607173.png)

![image-20250412222812668](学习/大模型/Model/文件资料/img/image-20250412222812668.png)

![image-20250412222930728](学习/大模型/Model/文件资料/img/image-20250412222930728.png)
...
![image-20250412223521523](学习/大模型/Model/文件资料/img/image-20250412223521523.png)



上面获取到的是json格式的数据。我们也可以让大模型把数据转换为 insert into 语句的数据，这样更加方便我们来直接使用了。

![image-20250412223904105](学习/大模型/Model/文件资料/img/image-20250412223904105.png)
...
![image-20250412224704924](学习/大模型/Model/文件资料/img/image-20250412224704924.png)
...
![image-20250412224818884](学习/大模型/Model/文件资料/img/image-20250412224818884.png)
...
![image-20250414152730817](学习/大模型/Model/文件资料/img/image-20250414152730817.png)
...
![image-20250414153030875](学习/大模型/Model/文件资料/img/image-20250414153030875.png)
...
![image-20250414155432692](学习/大模型/Model/文件资料/img/image-20250414155432692.png)

**定义**：零样本提示(Zero-shot) 是指模型在没有任何示例的情况下完成任务。模型必须依靠<span style="background:#9254de">其预训练知识和提示</span>来生成答案。
...
这种方法的优势是<font color="#ff0000">任务通用性高</font>，可以快速应用于各种新任务，而且能够节省训练资源和时间，也不会消耗特别多的Token。但由于没有针对特定任务进行训练，模型<font color="#ff0000">只能依靠预训练知识和推理能力</font>，所以生成内容的准确性可能不如经过特定任务训练的模型。例如，在<font color="#ff0000">专业领域的知识问答</font>任务中，零样本提示可能会因为模型对专业术语的理解不够准确或者缺乏专业知识细节，而生成不太准确的答案。
...
![image-20250414155702797](学习/大模型/Model/文件资料/img/image-20250414155702797.png)
...
相较于零样本提示，少样本提示能够提供更具体的任务信息，帮助模型更好地理解任务要求，从而提高任务性能。而且<span style="background:#9254de">与传统的有监督训练需要大量的标注数据不同，少样本提示只需要少量的精心选择的示例即可</span>，这对于<font color="#ff0000">数据获取困难或成本高昂</font>的任务非常有利。

但是，少样本提示的效果对示例的选择<font color="#ff0000">非常敏感</font>。示例的质量、多样性、代表性等因素都会影响模型的学习效果。如果示例过于简单或复杂、缺乏代表性或者存在错误，都可能导致模型学习到错误的任务模式。除此之外，这样做的代价是<font color="#ff0000">消耗更多的token</font>，并且当输入和输出文本较长时，可能会达到上下文长度限制。
...
![image-20250414160144180](学习/大模型/Model/文件资料/img/image-20250414160144180.png)

​	尽管少样本提示能够提高模型在特定任务上的性能，但与经过大量数据充分训练的模型相比，其性能仍然有限。在一些复杂任务中，如<font color="#ff0000">复杂的逻辑推理、高精度</font>的 翻译等任务，少样本提示可能无法满足要求，仍然需要更多的训练数据和精细的训练方法来进一步提升模型性能。
...
![图片来自Google官方](学习/大模型/Model/文件资料/img/c196a2a9077e41c1a47791744711fab5.png)
...
![image-20250414160552598](学习/大模型/Model/文件资料/img/image-20250414160552598.png)
...
![image-20250414191703693](学习/大模型/Model/文件资料/img/image-20250414191703693.png)

具体的案例

![image-20250414191806678](学习/大模型/Model/文件资料/img/image-20250414191806678.png)
...
![image-20250414192149472](学习/大模型/Model/文件资料/img/image-20250414192149472.png)
...
![image-20250414162028463](学习/大模型/Model/文件资料/img/image-20250414162028463.png)
...
![image-20250414194149339](学习/大模型/Model/文件资料/img/image-20250414194149339.png)
...
![image-20250214164938251](学习/大模型/Model/文件资料/img/image-20250214164938251.png)
